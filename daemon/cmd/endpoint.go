...
func (d *Daemon) createEndpoint(ctx context.Context, owner regeneration.Owner, epTemplate *models.EndpointChangeRequest) (*endpoint.Endpoint, int, error) {
	...
	ep, err := endpoint.NewEndpointFromChangeModel(d.ctx, owner, d.l7Proxy, d.identityAllocator, epTemplate, d.spiffeWatcher)
	if err != nil {
...
func (h *patchEndpointID) Handle(params PatchEndpointIDParams) middleware.Responder {
	...
	newEp, err2 := endpoint.NewEndpointFromChangeModel(h.d.ctx, h.d, h.d.l7Proxy, h.d.identityAllocator, epTemplate, h.d.spiffeWatcher)
	if err2 != nil {
		r.Error(err2)
