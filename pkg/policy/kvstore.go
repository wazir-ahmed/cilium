		...
		case event, ok := <-watcher.Events:
			...
			if event.Typ != kvstore.EventTypeListDone {
				...
				policyLabels = labels.LabelArray{
					labels.NewLabel(k8sConst.PolicyLabelName, policyName, labels.LabelSourceK8s),
					labels.NewLabel(k8sConst.PolicyLabelDerivedFrom, k8sUtils.ResourceTypeCiliumClusterwideNetworkPolicy, labels.LabelSourceK8s),
				}
			}
